        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
					...
					<li>
                        <a class="active-menu" href="roombook.php"><i class="fa fa-bar-chart-o"></i> Đặt Lịch</a>
                    </li>
                    <!-- <li>
                        <a href="payment.php"><i class="fa fa-qrcode"></i> Payment</a>
                    </li> -->
					<li>
                        <a  href="profit.php"><i class="fa fa-qrcode"></i> Doanh Số</a>
                    </li>
...
<?php
						...
						{	
							...
							if($st=="Conform")
							{
								...
								if($f1=="NO" )
								{
									echo "<script type='text/javascript'> alert('Xin Lỗi! Hội Trường A Không Có Sẵn ')</script>";
								}
								else if($f2 =="NO")
									{
										echo "<script type='text/javascript'> alert('Xin Lỗi! Hội Trường B Không Có Sẵn')</script>";
										
									}
									else if ($f3 == "NO")
									{
										echo "<script type='text/javascript'> alert('Xin Lỗi! Hội Trường C Không Có Sẵn')</script>";
									}
										else if($f4=="NO")
										{
										echo "<script type='text/javascript'> alert('Xin Lỗi! Hội Trường D Không Có Sẵn')</script>";
										}
											...
											{	
												...
												//echo "<script type='text/javascript'> window.location='home.php'</script>";
												 $type_of_room = 0;       
														...
														else if($troom=="Hall B")
														{
															$type_of_room = 220;
														}
														else if($troom=="Hall C")
														{
															$type_of_room = 180;
														}
														else if($troom=="Hall D")
														{
															$type_of_room = 150;
														}
