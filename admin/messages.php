            ...
            <div id="page-inner">
			 <div class="row">
			   ...
			   ?>
                ...
                <div class="col-md-12">
                    <div class="jumbotron">
                        <h3>Gửi Tin Tức Cho Người Followers</h3>
						<?php
						...
						<div class="panel-body">
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <label>Tiêu Đề</label>
                                            <input name="title" class="form-control" placeholder="Soạn Tiêu Đề">
											</div>
										</div>
										<div class="modal-body">
                                            <div class="form-group">
                                            <label>Chủ Đề</label>
                                            <input name="subject" class="form-control" placeholder="Soan Chủ Đề">
											</div>
                                        </div>
										<div class="modal-body">
										<div class="form-group">
							...
							{	
								...
								{
									echo '<script>alert("Gửi Thư Thành Công") </script>' ;
